...
public class Tabla {
    ...
    private int recursocabecera;

    int color, a = Color.rgb(140, 140, 140), b = Color.rgb(191, 191, 191);
     ...
     */
    public Tabla(Activity actividad, TableLayout tabla, int recursocabecera)
    {
        ...
        this.recursocabecera = recursocabecera;
    }
    ...
    public void agregarCabecera()
    {
        ...
        for(int i = 0; i < arraycabecera.length; i++)
        {
            ...
            texto.setBackgroundColor(Color.rgb(64,64,64));
            texto.setTextSize(22);
            texto.setTextColor(Color.rgb(250,250,250));
    ...
    public void eliminarFilasTabla()
    {
        TableRow.LayoutParams layoutCelda;
        TableRow.LayoutParams layoutFila = new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT, TableRow.LayoutParams.WRAP_CONTENT);
        TableRow fila = new TableRow(actividad);
